  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 style={{fontFamily: "'Source Serif 4', serif", fontSize: 'clamp(24px, 5vw, 36px)', fontWeight: 200, margin: 0}}>Certificates</h1>
                  ...
                  <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                    {cert.state !== 'revoked' && cert.state !== 'suspended' ? (
                      <a 
                        ...
                        style={{background: styles.purplePrimary, border: `1px solid ${styles.purpleBright}`, color: 'rgba(255,255,255,.94)', fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', letterSpacing: '1px', textTransform: 'uppercase'}}
                      >
                        Download PDF
                      </a>
                    ) : (
                    ...
                    <Link to={`/verify?cert=${cert.certificate_number}`} className="px-2 py-1 no-underline" style={{background: 'transparent', border: `1px solid ${styles.borderGlass}`, color: styles.textSecondary, fontFamily: "'IBM Plex Mono', monospace", fontSize: '9px', letterSpacing: '0.5px', textTransform: 'uppercase'}}>Verify</Link>
                  </div>
                </td>
              </tr>
            ))}

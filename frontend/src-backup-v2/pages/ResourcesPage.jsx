  ...
  return (
    <div style={{ padding: '32px', maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ marginBottom: '32px' }}>
        ...
        <h1 style={{
          fontFamily: "'Source Serif 4', serif", fontSize: 'clamp(20px, 4vw, 28px)',
      ...
      {loading ? (
        ...
        <div style={{
          padding: 'clamp(16px, 4vw, 40px)', textAlign: 'center', border: '1px solid ' + styles.borderGlass, borderRadius: '18px', background: styles.bgDeep,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {documents.map(doc => (
            <div key={doc.id} style={{
              padding: '24px', border: '1px solid ' + styles.borderGlass, borderRadius: '18px', background: styles.bgDeep,
              ...
              <button
                ...
                style={{
                  ...
                  color: 'rgba(255,255,255,.94)', fontFamily: "'IBM Plex Mono', monospace",

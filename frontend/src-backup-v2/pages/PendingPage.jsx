  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: styles.bgPrimary || '#0d0f14', padding: '20px' }}>
      <div style={{ maxWidth: 'min(500px, 90vw)', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: "'Source Serif 4', serif", fontSize: 'clamp(20px, 4vw, 28px)', fontWeight: 200, color: styles.textPrimary || '#e8e6f0', margin: '0 0 16px' }}>Welcome to Sentinel Authority</h1>
        ...
        <div style={{ padding: '20px', border: '1px solid ' + (styles.borderGlass || 'rgba(255,255,255,0.06)'), background: 'rgba(255,255,255,0.02)', marginBottom: '24px', textAlign: 'left' }}>
        ...
        <button onClick={logout} style={{ padding: '10px 24px', background: 'transparent', border: '1px solid ' + (styles.borderGlass || 'rgba(255,255,255,0.06)'), color: styles.textTertiary || '#596270', fontFamily: "'IBM Plex Mono', monospace", fontSize: '11px', letterSpacing: '1px', textTransform: 'uppercase', cursor: 'pointer' }}>Sign Out</button>
      </div>
    </div>
  );
}

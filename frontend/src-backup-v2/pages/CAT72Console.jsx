  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 style={{fontFamily: "'Source Serif 4', serif", fontSize: 'clamp(24px, 5vw, 36px)', fontWeight: 200, margin: 0}}>CAT-72 Console</h1>
              ...
              return (
                <Panel key={test.id}>
                  ...
                  <div style={{display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '8px'}}>
                    <div style={{fontFamily: "'IBM Plex Mono', monospace", fontSize: 'clamp(20px, 4vw, 28px)', fontWeight: 200, color: styles.purpleBright, letterSpacing: '2px'}}>{formatTime(test.elapsed_seconds)}</div>
                    <div style={{flex: 1}}>
            ...
            <tbody>
              {completedTests.map(test => (
                <tr key={test.id} style={{borderBottom: `1px solid ${styles.borderGlass}`}}>
                  ...
                  <td className="px-4 py-4">
                    <span style={{fontFamily: "'IBM Plex Mono', monospace", fontSize: '12px', fontWeight: 600, color: test.result === 'PASS' ? styles.accentGreen : styles.accentRed, padding: '4px 10px', background: test.result === 'PASS' ? 'rgba(92,214,133,0.04)' : 'rgba(214,92,92,0.04)'}}>{test.result}</span>
                  </td>

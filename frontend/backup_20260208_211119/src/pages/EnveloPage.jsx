  ...
  return (
    <div style={{maxHeight: '300px', overflowY: 'auto'}}>
      <table style={{width: '100%', borderCollapse: 'collapse', fontSize: '12px'}}>
        ...
        <tbody>{records.map((r, i) => (<tr key={i} style={{borderBottom: '1px solid rgba(255,255,255,0.05)'}}><td style={{padding: '8px', fontFamily: 'monospace', fontSize: '11px', color: '#aaa'}}>{r.timestamp ? new Date(r.timestamp).toLocaleTimeString() : '-'}</td><td style={{padding: '8px', color: '#fff'}}>{r.action_type}</td><td style={{padding: '8px'}}><span style={{padding: '2px 8px', fontSize: '10px', fontWeight: 400, background: r.result === 'PASS' ? 'rgba(92,214,133,0.2)' : 'rgba(214,92,92,0.2)', color: r.result === 'PASS' ? '#5CD685' : '#D65C5C'}}>{r.result}</span></td><td style={{padding: '8px', color: '#666', fontFamily: 'monospace', fontSize: '10px'}}>{JSON.stringify(r.parameters || {})}</td></tr>))}</tbody>
      </table>
    </div>
  );
}
    ...
    <div>
      {generatedKey && (
        <div style={{background: 'transparent', border: '1px solid rgba(255,255,255,0.07)', padding: '16px', marginBottom: '20px'}}>
          ...
          <div style={{background: 'rgba(0,0,0,0.3)', padding: '12px', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '13px', color: styles.textPrimary, wordBreak: 'break-all', marginBottom: '12px'}}>
            {generatedKey.key}
          </div>
          <div style={{display: 'flex', gap: '12px'}}>
            <button onClick={copyKey} style={{padding: '8px 16px', background: styles.purplePrimary, border: `1px solid ${styles.purpleBright}`, color: '#fff', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '11px', cursor: 'pointer'}}>Copy to Clipboard</button>
          ...
          <div style={{marginTop: '16px', padding: '16px', background: 'rgba(91,75,138,0.2)', border: '1px solid rgba(91,75,138,0.3)' }}>
            ...
            <button 
              ...
              style={{padding: '12px 24px', background: styles.purplePrimary, border: `1px solid ${styles.purpleBright}`, color: '#fff', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '12px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px'}}
            >
      ...
      <div style={{display: 'flex', gap: '12px', marginBottom: '20px'}}>
        <input
          ...
          style={{flex: 1, padding: '10px 14px', background: 'rgba(0,0,0,0.3)', border: `1px solid ${styles.borderGlass}`, color: styles.textPrimary, fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '13px'}}
        />
        <button
          onClick={generateKey}
          disabled={!newKeyName.trim()}
          style={{padding: '10px 20px', background: newKeyName.trim() ? styles.purplePrimary : 'transparent', border: `1px solid ${newKeyName.trim() ? styles.purpleBright : styles.borderGlass}`, color: newKeyName.trim() ? '#fff' : styles.textTertiary, fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '11px', letterSpacing: '1px', textTransform: 'uppercase', cursor: newKeyName.trim() ? 'pointer' : 'not-allowed'}}
        >
          Generate Key
        </button>
      </div>
        ...
        <div key={i} style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid ' + styles.borderGlass, padding: '12px', marginBottom: '8px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '8px' }}>
            ...
            <div style={{ display: 'flex', gap: '4px' }}>
              ...
              {bounds.numeric.length > 1 && <button onClick={() => removeRow('numeric', i)} style={{ background: 'rgba(214,92,92,0.05)', border: 'none', color: styles.accentRed, cursor: 'pointer', padding: '0 8px', fontSize: '14px' }}>×</button>}
            </div>
          </div>
        </div>
      ))}
        ...
        <div key={i} style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid ' + styles.borderGlass, padding: '12px', marginBottom: '8px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '8px' }}>
            ...
            <div style={{ display: 'flex', gap: '4px' }}>
              ...
              {bounds.geo.length > 1 && <button onClick={() => removeRow('geo', i)} style={{ background: 'rgba(214,92,92,0.05)', border: 'none', color: styles.accentRed, cursor: 'pointer', padding: '0 8px', fontSize: '14px' }}>×</button>}
            </div>
          </div>
        </div>
      ))}
      ...
      {bounds.time.map((b, i) => (
        <div key={i} style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid ' + styles.borderGlass, padding: '12px', marginBottom: '8px' }}>
          ...
          <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {bounds.time.length > 1 && <button onClick={() => removeRow('time', i)} style={{ marginLeft: 'auto', background: 'rgba(214,92,92,0.05)', border: 'none', color: styles.accentRed, cursor: 'pointer', padding: '2px 8px', fontSize: '14px' }}>×</button>}
          </div>
        </div>
      ))}
        ...
        <div key={i} style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid ' + styles.borderGlass, padding: '12px', marginBottom: '8px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
            ...
            <div style={{ display: 'flex', gap: '4px' }}>
              ...
              {bounds.state.length > 1 && <button onClick={() => removeRow('state', i)} style={{ background: 'rgba(214,92,92,0.05)', border: 'none', color: styles.accentRed, cursor: 'pointer', padding: '0 8px', fontSize: '14px', alignSelf: 'flex-start' }}>×</button>}
            </div>
          </div>
        </div>
      ))}
        ...
        <>
          ...
          <Panel glow>
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px', marginBottom: '20px'}}>
              ...
              <div style={{display: 'flex', alignItems: 'center', gap: '8px', padding: '4px 12px', background: 'rgba(92,214,133,0.05)' }}>
                  ...
                  <tbody>
                    {sessions.map((s, i) => (
                      <tr key={i} className="sexy-row" style={{borderBottom: `1px solid ${styles.borderGlass}`}}>
                        ...
                        <td style={{padding: '16px'}}>
                          <button onClick={() => setSelectedSession(s)} style={{padding: '6px 12px', background: 'rgba(157,140,207,0.05)', border: `1px solid ${styles.purpleBright}`, color: styles.purpleBright, fontSize: '11px', cursor: 'pointer'}}>View Details</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
                  ...
                  <div key={cert.id} style={{padding: '20px', background: 'transparent', border: `1px solid ${styles.borderGlass}` }}>
                    <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px'}}>
                      ...
                      <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
                        <button onClick={() => { setReviewingCert(cert); setActiveTab('review'); }} style={{padding: '8px 16px', background: 'rgba(157,140,207,0.05)', border: `1px solid ${styles.purpleBright}`, color: styles.purpleBright, fontSize: '11px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px'}}>
                ...
                {pendingApps.map(app => (
                  <div key={app.id} style={{padding: '16px', background: 'transparent', border: `1px solid ${styles.borderGlass}`}}>
                    <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px'}}>
                      ...
                      <span style={{padding: '4px 12px', background: 'rgba(214,160,92,0.05)', border: '1px solid rgba(255,255,255,0.07)', fontSize: '10px', color: styles.accentAmber, fontFamily: "Consolas, 'IBM Plex Mono', monospace", textTransform: 'uppercase'}}>
          ...
          {reviewingCert ? (() => {
            ...
            return (
              <Panel glow>
                ...
                <div style={{padding: '12px 16px', background: 'transparent', border: '1px solid rgba(214,160,92,0.2)', marginBottom: '24px'}}>
                  ...
                  <div style={{display: 'flex', gap: '12px', marginTop: '16px'}}>
                    <button
                      ...
                      style={{
                        ...
                        border: `1px solid ${styles.accentGreen}`, color: styles.accentGreen, fontFamily: "Consolas, 'IBM Plex Mono', monospace",
                    ...
                    <button
                      ...
                      style={{
                        flex: 1, padding: '14px', background: 'transparent',
                        border: '1px solid rgba(255,255,255,0.07)', color: styles.accentRed, fontFamily: "Consolas, 'IBM Plex Mono', monospace",
                        fontSize: '12px', letterSpacing: '1px', textTransform: 'uppercase',
                        cursor: 'pointer'
                      }}
                    >
            ...
            <Panel>
              <div style={{textAlign: 'center', padding: 'clamp(24px, 5vw, 60px) clamp(12px, 3vw, 20px)'}}>
                ...
                <button onClick={() => setActiveTab('customers')} style={{padding: '12px 24px', background: styles.purplePrimary, border: `1px solid ${styles.purpleBright}`, color: '#fff', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '11px', letterSpacing: '1px', textTransform: 'uppercase', cursor: 'pointer'}}>View Customer Systems</button>
              </div>
            </Panel>
          )}
        </>
          ...
          return (
            <Panel key={cert.id} glow={isOnline}>
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '20px'}}>
                ...
                <div style={{display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: 'rgba(92,214,133,0.05)' }}>
        ...
        <Panel>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '12px'}}>
            <button
              ...
              style={{padding: '16px', background: 'transparent', border: '1px solid rgba(214,92,92,0.2)', cursor: 'pointer', textAlign: 'left'}}
            >
            ...
            <button
              ...
              style={{padding: '16px', background: 'rgba(91,75,138,0.04)', border: '1px solid rgba(91,75,138,0.2)', cursor: 'pointer', textAlign: 'left'}}
            >
          ...
          {showUninstall && (
            <div style={{marginTop: '16px', padding: '16px', background: 'rgba(0,0,0,0.3)', border: '1px solid ' + styles.borderGlass}}>
              ...
              <div style={{fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '12px', color: styles.textSecondary, padding: '12px', background: 'rgba(0,0,0,0.3)', whiteSpace: 'pre-wrap', lineHeight: '1.8'}}>
          ...
          <div style={{marginTop: '16px', padding: '12px', background: 'transparent' }}>
            ...
            <div style={{fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '12px', color: styles.textSecondary, padding: '8px', background: 'rgba(0,0,0,0.3)' }}>cat ~/.envelo/envelo.log</div>
          </div>
        </Panel>
      </div>
    );
          ...
          {!deployKey ? (
            ...
            <>
              ...
              <div style={{maxWidth: 'min(700px, 95vw)', margin: '0 auto', textAlign: 'left'}}>
                <div style={{background: 'rgba(0,0,0,0.5)', border: '1px solid ' + styles.purpleBright, overflow: 'hidden'}}>

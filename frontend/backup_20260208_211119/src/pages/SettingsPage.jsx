    ...
    <div className="space-y-6" style={{maxWidth: 'min(700px, 95vw)', margin: '0 auto'}}>
      ...
      <Panel>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: '12px', maxWidth: 'min(400px, 90vw)'}}>
          ...
          <button onClick={handleChangePassword} disabled={pwSaving} className="sexy-btn" style={{padding: '10px 24px', background: styles.purplePrimary, border: `1px solid ${styles.purpleBright}`, color: '#fff', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '11px', letterSpacing: '1px', textTransform: 'uppercase', cursor: pwSaving ? 'wait' : 'pointer', opacity: pwSaving ? 0.7 : 1, alignSelf: 'flex-start'}}>
        ...
        {twoFA.loading ? (
          ...
          <div style={{maxWidth: 'min(400px, 90vw)'}}>
            ...
            <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
              ...
              <button onClick={enable2FA} disabled={twoFA.verifying || twoFA.code.length !== 6} className="sexy-btn" style={{padding: '10px 20px', background: styles.purplePrimary, border: `1px solid ${styles.purpleBright}`, color: '#fff', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '10px', letterSpacing: '1px', textTransform: 'uppercase', cursor: twoFA.verifying ? 'wait' : 'pointer', opacity: twoFA.code.length !== 6 ? 0.5 : 1}}>
          ...
          <div>
            ...
            <button onClick={setup2FA} className="sexy-btn" style={{padding: '10px 24px', background: styles.purplePrimary, border: `1px solid ${styles.purpleBright}`, color: '#fff', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '11px', letterSpacing: '1px', textTransform: 'uppercase', cursor: 'pointer'}}>
              Enable 2FA
            </button>
          </div>
        )}

        ...
        <div style={{ background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', padding: '2rem', maxWidth: 'min(400px, 90vw)', width: '100%' }}>
          ...
          <div>
            <input
              ...
              style={{ width: '100%', padding: '0.75rem', background: 'transparent', border: '1px solid rgba(255,255,255,0.15)', color: '#fff', fontSize: '1rem', marginBottom: '1rem', boxSizing: 'border-box' }}
            />
            {error && <p style={{ color: '#ff6b6b', fontSize: '0.85rem', marginBottom: '0.5rem' }}>{error}</p>}
            <button
              onClick={handleUnlock}
              style={{ width: '100%', padding: '0.75rem', background: '#5B4B8A', border: 'none', color: '#fff', fontSize: '1rem', cursor: 'pointer' }}
            >
              Unlock Docs
            </button>
          </div>

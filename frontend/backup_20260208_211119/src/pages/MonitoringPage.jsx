          ...
          <div style={{padding: '20px'}}>
            ...
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px', marginBottom: '24px'}}>
              ...
              {selectedSession.is_online && (
                <button
                  ...
                  style={{padding: '8px 16px', background: 'transparent', border: '1px solid rgba(255,255,255,0.07)', color: '#D65C5C', cursor: 'pointer', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '10px', letterSpacing: '1px', textTransform: 'uppercase'}}
                >
                  Force End Session
                </button>
              )}
            ...
            <div style={{display: 'flex', gap: '8px', marginBottom: '24px', flexWrap: 'wrap'}}>
              <button
                ...
                style={{padding: '8px 16px', background: 'rgba(157,140,207,0.04)', border: '1px solid rgba(255,255,255,0.07)', color: styles.purpleBright, cursor: 'pointer', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '10px', letterSpacing: '1px', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '6px'}}
              >
                ↓ Telemetry CSV
              </button>
              <button
                ...
                style={{padding: '8px 16px', background: 'transparent', border: '1px solid rgba(255,255,255,0.06)', color: '#D65C5C', cursor: 'pointer', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '10px', letterSpacing: '1px', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '6px'}}
              >
                ↓ Violations CSV
              </button>
              <button
                ...
                style={{padding: '8px 16px', background: 'transparent', border: '1px solid rgba(92,214,133,0.25)', color: styles.accentGreen, cursor: 'pointer', fontFamily: "Consolas, 'IBM Plex Mono', monospace", fontSize: '10px', letterSpacing: '1px', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '6px'}}
              >
                ↓ CAT-72 Report PDF
              </button>
            </div>

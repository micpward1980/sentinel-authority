...
function Layout({ children }) {
  ...
  /* Standardized frost values */
  const frost = {
    background: 'rgba(245,245,247,0.88)',
    backdropFilter: styles.frostChrome,
    WebkitBackdropFilter: styles.frostChrome,
  ...
  return (
    <div style={{minHeight: '100vh', color: styles.textPrimary, fontFamily: styles.sans, background: styles.bgDeep}}>
      ...
      <div style={{
        ...
        borderRight: frost.border,
      }}>
        <div style={{
          height: '72px',
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          padding: '0 16px',
          borderBottom: frost.border,
        }}>
        ...
        <div style={{position: 'absolute', bottom: 0, left: 0, right: 0, padding: '16px', borderTop: frost.border}}>
          <div style={{display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px'}}>
            ...
            <div>
              ...
              <div style={{fontFamily: styles.mono, fontSize: '10px', letterSpacing: '2.4px', textTransform: 'uppercase', color: styles.textTertiary}}>{user?.role}</div>
            </div>
          </div>
          <button onClick={logout} style={{
            display: 'flex', alignItems: 'center', gap: '8px',
            fontFamily: styles.mono, fontSize: '10px', letterSpacing: '2.4px', textTransform: 'uppercase',
      ...
      <div style={{marginLeft: isMobile ? 0 : '240px', position: 'relative', zIndex: 10}}>
        <header style={{
          ...
          <a href="https://sentinelauthority.org"
            style={{display: 'flex', alignItems: 'center', gap: '6px', color: styles.textTertiary, fontFamily: styles.mono, fontSize: '10px', letterSpacing: '2.4px', textTransform: 'uppercase', textDecoration: 'none', padding: '8px 4px', transition: 'color 0.25s ease'}}
            onMouseEnter={e => e.currentTarget.style.color = styles.textPrimary}
            onMouseLeave={e => e.currentTarget.style.color = styles.textTertiary}>
          ...
          <div style={{position: 'relative'}}>
            ...
            {notifOpen && (<>
              ...
              <div style={{position: 'absolute', right: 0, top: '44px', width: 'min(340px, 90vw)', maxHeight: '70vh', overflowY: 'auto', background: frost.background, backdropFilter: frost.backdropFilter, WebkitBackdropFilter: frost.WebkitBackdropFilter, border: frost.border, zIndex: 100}}>
                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', borderBottom: frost.border}}>
                  <span style={{fontFamily: styles.mono, fontSize: '10px', letterSpacing: '2.4px', textTransform: 'uppercase', color: styles.textTertiary}}>Notifications</span>
                  {unreadCount > 0 && <button onClick={markAllRead} style={{background: 'none', border: 'none', color: styles.purpleBright, fontFamily: styles.mono, fontSize: '10px', letterSpacing: '1px', cursor: 'pointer', padding: 0}}>Mark all read</button>}
                </div>
                {notifs.length === 0 ? (
                    ...
                    <div key={n.id || i}
                      ...
                      <div style={{display: 'flex', gap: '10px', alignItems: 'flex-start'}}>
                        ...
                        <div style={{flex: 1, minWidth: 0}}>
                          ...
                          <span style={{fontFamily: styles.mono, fontSize: '10px', color: styles.textDim, marginTop: '4px', display: 'block'}}>

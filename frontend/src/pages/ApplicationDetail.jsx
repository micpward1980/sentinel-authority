...
function ApplicationDetail() {
  ...
  const confirmStateChange = async () => {
    ...
    try {
      ...
      // Auto-provision API key + auto-schedule CAT-72 on approval
      if (emailPreview.newState === 'approved') {
        try { await api.post('/api/apikeys/admin/provision', null, { params: { application_id: id, send_email: true } }); } catch (e) { console.error('Auto-provision:', e.message); }

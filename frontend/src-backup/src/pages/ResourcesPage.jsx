  ...
  return (
    <div style={{ padding: '32px', maxWidth: '900px', margin: '0 auto' }}>
      ...
      {loading ? (
        ...
        <div style={{
          padding: 'clamp(16px, 4vw, 40px)', textAlign: 'center', border: '1px solid ' + styles.borderGlass, background: styles.bgCard,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {documents.map(doc => (
            <div key={doc.id} style={{
              padding: '24px', border: '1px solid ' + styles.borderGlass, background: styles.bgCard,
